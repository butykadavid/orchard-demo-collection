...
export default function App() {
  ...
  return (
    <>
      <div className="p-2 md:p-4 flex flex-col min-h-screen w-full items-center justify-start bg-zinc-50 font-sans">
        <Card className="p-4 w-full max-w-lg">
          <div className="flex justify-center mb-4">
            <img src="/title.png" alt="Turing Machine" className="text-3xl font-bold w-[20vw]" />
          </div>
          {isGameStarted ? (
            <>
                  ...
                  <div className="w-full flex flex-col gap-2">
                    <Card className="px-4 py-2 mb-4">
                      <div className="w-full flex justify-between items-center">
                        ...
                        <span className="font-semibold text-lg text-center">
                          Score: {score.rounds} - {score.validations}
                        </span>
                      </div>
                    </Card>
                      ...
                      >
                        ...
                        <div>
                          <ValidatorRow
                            ...
                            onChange={(key) => changeValidator(key)}
                          />
                        </div>
                      </div>
                    ))}
                    <Button
                      size="lg"
                      className="px-16 mt-4 hover:cursor-pointer"
                    ...
                    <Button
                      variant="outline"
                      size="lg"
                      className="px-16 hover:cursor-pointer"
            ...
            <>
              <Input
                ...
                placeholder="Game ID"
                id="gameIdInput"
                className="text-center text-xl font-bold uppercase mb-4"
                onChange={(e) => handleInput(e)}
              />
              <div className="text-center text-gray-600 mb-4">
                Select number of validator columns
              </div>
              <div className="flex justify-between items-center gap-4">
                <Button
                  size="lg"
                  className="px-8 hover:cursor-pointer flex-1"
